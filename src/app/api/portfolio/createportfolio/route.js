...
export async function POST(req, res) {
  try {
    ...
    await Portfolio.create({ userId: userdetails._id, Assests: Assests, PortfolioName: pname, Price: total, PortfolioPrice: [data], RemainingPrice: total, PercentageRemaining: 100 })
