    ...
    <>
      <div className="flex flex-col break-words w-screen md:w-[70vw] mx-auto mb-4 border-1 shadow-lg rounded bg-transparent">
        ...
        <div className="p-4 flex flex-col items-center w-[100%]">
          ...
          <Link href={'/dashboard/viewasset'} className="w-fit text-purple-800 bg-white hover:bg-gray-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm mx-2 px-2 py-2.5 text-center ">View Assets</Link>
