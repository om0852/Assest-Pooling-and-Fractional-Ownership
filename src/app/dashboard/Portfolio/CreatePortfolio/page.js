...
const page = () => {
  ...
  const createportfolio = async () => {
    ...
    const res = await fetch(
      `http://localhost:3000/api/portfolio/createportfolio`,
      {
        method: "POST",
        headers: {
  ...
  const removeAssest = async (index) => {
    let arr=Assests
    arr.splice(index,1)
    setAssests(arr)
  };
    ...
    <div className=" w-[100%] h-full rounded p-2 pb-4 md:px-16 items-center justify-center px-6 py-8 mx-auto ">
      ...
      <div className=" w-full h-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
        <div className=" p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <div className="w-full mx-auto flex flex-col items-center justify-center px-6 py-2  lg:py-0">
